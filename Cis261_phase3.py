...
# write the line of code to assign Employees.txt to the variable FILENAME
...
def GetDatesWorked():
      while True:
              ...
              try:
                    fromdate = datetime.datetime.strptime(date_str, "%Y-%m-%d")
              except ValueError:
      ...
      while True:
              ...
              try:
                     todate = datetime.datetime.strptime(date_str, "%Y-%m-%d")
              except ValueError:
                      print("Invalid date format. Try again.")
                      print()
              if todate <= fromdate:
...
def printinfo(DetailsPrinted):
     ...
     # write the line of code that will open the file in read mode and assign it to EmpFile
      with open(FILENAME, 'r') as EmpFile:
            ...
            while True:
                    ...
                    # write the if statement that will break out of the while loop when no data is left in the file
                    if not EmpDetail:
                       break
